...
const ACCESS_TOKEN_TTL = '24h' // 30 phut
const REFRESH_TOKEN_TTL = 14 * 24 * 60 * 60 * 1000; //14 ngày

/**
 * Hàm đăng ký 
 * @param {*} req.body - Lấy username, password và email  người dùng nhập 
 * @param {*} res 
 ...
 * @param {*} req.body - Lấy password và email người dùng nhập
 * @param {*} res 
...
/**
 * Đăng xuất
 * @param {*} req.cookie - Refresh token
 * @param {*} res 
